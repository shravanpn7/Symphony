...
<body style="background-color:#eee;background-size:100%;">
     ...
     <h1 style="text-align:center;">Artist page</h1> 
		...
		<c:forEach var="product" items="${it.ArtistDetails}">
			<table style="border:2px solid #000; float:left; border-radius:10px; box-shadow: 0px 0px 13px 1px; width: 400px; background-color: #f5f5f5; margin: 25px; padding: 25px 0px; text-align: center; ">
			<tr><td>ArtistId:</td>
